...
function AlgorithmsCatalog() {
  ...
  return (
    <section className="flex min-w-0 flex-col gap-4">
      <div className="rounded-[18px] border border-slate-300/70 bg-linear-to-b from-white/95 to-white/80 p-4 shadow-lg sm:p-5">
      ...
      <div className="rounded-xl border border-slate-300/70 bg-white/85 p-3 shadow-sm backdrop-blur-sm sm:p-4">
        <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto]">
          ...
          <div className="flex flex-wrap items-end gap-2">
            ...
            <Link
              to="/legacy-home"
              className="inline-flex h-10 items-center justify-center rounded-md border border-slate-300 bg-white px-3 text-sm font-semibold text-slate-900 hover:bg-slate-50"
            >
              Scroll Page
            </Link>
          </div>
        ...
        {filtersOpen ? (
          <div id="catalog-filters-panel" className="mt-3 rounded-lg border border-slate-200 bg-slate-50/85 p-3">
